...
def runFigure(flux, detectedWavePeaks_solo, its_a_match_peaks,its_a_match_waves, header, filelist_wave, peak_weight, saveWhere):
    ...
    return pix_to_wavelength_map_best
...
def figure4(flux, pix_to_wavelength_map_best,its_a_match_peaks,its_a_match_waves, pixels, output_dir):
    fig4, axs4 = plt.subplots(2, num="wavelength position", clear=True, figsize=(13, 7))
    ...
    # Polynomial fit and peak detection on bottom plot
    axs4[1].plot(pixels, pix_to_wavelength_map_best, label='Polynomial fit (deg={})'.format(2))
    axs4[1].plot(its_a_match_peaks, its_a_match_waves, 'o', label='Detected peaks')
    axs4[1].set_title("Wavelength vrs Pixels new")
    axs4[1].set_xlabel("Pixel number")
    axs4[1].set_ylabel("Wavelength (nm)")
    axs4[1].legend()
...
def runCreateWavelengthMap(filepath, wave_list_string, saveWhere = ""):
    ...
    runFigure(flux, detectedWavePeaks_solo_list, its_a_match_peaks,its_a_match_waves, header, filelist_wave, peak_weight, saveWhere)
...
if __name__ == "__main__":
    ...
    runCreateWavelengthMap(filelist, wave_list_string_default)
